...
<html lang="zxx">
    <head>
        ...
        <!-- Title -->
        <title>Pixis - Print on Demand Service Providers HTML Template</title>
                ...
                <div class="row pt-45">
                    <div class="col-lg-6">
                        <div class="client-card">
                            <img src="assets/img/testimonail/2.jpg" alt="Images">
                            <h3>Evana Yas</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="client-card">
                            <img src="assets/img/testimonail/3.jpg" alt="Images">
                            <h3>John Smith</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="client-card">
                            <img src="assets/img/testimonail/5.jpg" alt="Images">
                            <h3>Annie Smith</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="client-card">
                            <img src="assets/img/testimonail/4.jpg" alt="Images">
                            <h3>Knot Doe</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-9">
                            <div class="bottom-text">
                                <p>
                                    Copyright ©2020 Pixis. All Rights Reserved by 
                                    <a href="https://hibootstrap.com/" target="_blank">HiBootsrap</a> 
                                </p>
